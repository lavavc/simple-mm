...
```bash
pytest -q tests/test_backtester.py tests/test_v4_export.py tests/test_params_validation.py tests/test_price_math.py tests/test_lp_ratio.py
```
...
```bash
python -m backtester.run --csv data/uni_base_pool_history.csv --dataset-format v4 --pool uni-base --strategy-mode ewma --initial-capital-usd 1200 --output backtester/results/uni_base_ewma_full_grid.csv
python -m backtester.run --csv data/uni_base_pool_history.csv --dataset-format v4 --pool uni-base --strategy-mode paper --initial-capital-usd 1200 --output backtester/results/uni_base_paper_full_grid.csv
```

Base swap-count walk-forward:

```bash
python -m backtester.run --csv data/uni_base_pool_history.csv --dataset-format v4 --pool uni-base --strategy-mode ewma --initial-capital-usd 1200 --walkforward --window-mode swap_count --train-swaps 200 --val-swaps 50 --stride-swaps 50 --min-train-swaps 200 --min-train-liquidity-events 0 --min-val-swaps 50 --top-n 20 --output backtester/results/uni_base_ewma_swapwf.csv
python -m backtester.run --csv data/uni_base_pool_history.csv --dataset-format v4 --pool uni-base --strategy-mode paper --initial-capital-usd 1200 --walkforward --window-mode swap_count --train-swaps 200 --val-swaps 50 --stride-swaps 50 --min-train-swaps 200 --min-train-liquidity-events 0 --min-val-swaps 50 --top-n 20 --output backtester/results/uni_base_paper_swapwf.csv
```

BSC full-grid:

```bash
python -m backtester.run --csv data/uni_bsc_pool_history.csv --dataset-format v4 --pool uni-bsc --strategy-mode ewma --initial-capital-usd 450 --output backtester/results/uni_bsc_ewma_full_grid.csv
python -m backtester.run --csv data/uni_bsc_pool_history.csv --dataset-format v4 --pool uni-bsc --strategy-mode paper --initial-capital-usd 450 --output backtester/results/uni_bsc_paper_full_grid.csv
```

BSC swap-count walk-forward:

```bash
python -m backtester.run --csv data/uni_bsc_pool_history.csv --dataset-format v4 --pool uni-bsc --strategy-mode ewma --initial-capital-usd 450 --walkforward --window-mode swap_count --train-swaps 300 --val-swaps 75 --stride-swaps 75 --min-train-swaps 300 --min-train-liquidity-events 0 --min-val-swaps 75 --top-n 20 --output backtester/results/uni_bsc_ewma_swapwf.csv
python -m backtester.run --csv data/uni_bsc_pool_history.csv --dataset-format v4 --pool uni-bsc --strategy-mode paper --initial-capital-usd 450 --walkforward --window-mode swap_count --train-swaps 300 --val-swaps 75 --stride-swaps 75 --min-train-swaps 300 --min-train-liquidity-events 0 --min-val-swaps 75 --top-n 20 --output backtester/results/uni_bsc_paper_swapwf.csv
```
