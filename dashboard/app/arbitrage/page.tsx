...
export default function ArbitragePage() {
  ...
  return (
    <div className="relative flex flex-col min-h-[calc(100vh-4rem)] bg-[#0B0E14] text-slate-300 p-2 md:p-6 animate-in fade-in duration-500 font-sans space-y-6 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.04] bg-[linear-gradient(rgba(16,185,129,0.3)_1px,transparent_1px),linear-gradient(90deg,rgba(16,185,129,0.3)_1px,transparent_1px)] bg-[size:60px_60px] [mask-image:radial-gradient(ellipse_at_center,black_10%,transparent_80%)]" />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-white/[0.05] pb-4 z-10 gap-4 md:gap-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xs font-bold tracking-widest uppercase text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">Arbitrage</h1>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 z-10">
        ...
        <div className="md:col-span-3 flex flex-col gap-6">
          ...
          <Card className="relative bg-gradient-to-b from-white/[0.03] to-white/[0.01] border-white/[0.05] backdrop-blur-xl shadow-2xl rounded-sm">
          ...
          <Card className="relative bg-gradient-to-b from-white/[0.03] to-white/[0.01] border-white/[0.05] backdrop-blur-xl shadow-2xl rounded-sm">
            ...
            <CardContent className="pt-4 grid grid-cols-2 gap-x-2 gap-y-4">
              <div>
        ...
        <div className="md:col-span-9 flex flex-col h-full">
          <Card className="relative bg-[#12161C] border border-white/[0.05] rounded-sm shadow-none flex-1 flex flex-col">
              ...
              {oppsLoading ? (
                ...
                <div className="overflow-x-auto flex-1 h-full">
                  <table className="w-full text-left font-mono">
                    <thead className="sticky top-0 bg-[#0B0E14]/90 backdrop-blur-md z-10">
                    ...
                    <tbody className="divide-y divide-white/[0.04]">
                      {opportunities.map((opp, idx) => (
                        <tr key={opp.id} className="hover:bg-white/[0.04] transition-colors text-[11px] text-white/90">
