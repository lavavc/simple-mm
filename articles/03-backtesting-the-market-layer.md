...
- LP backtester with walk-forward outputs under `backtester/results/`
...
- `autoresearch/lp.md`
- `autoresearch/data-methodology-refactor.md`
- `backtester/`
- `backtester/results/`
- `scripts/export_fair_price_markouts.py`
- `scripts/analyze_fair_price_markouts.py`
- `scripts/report_fair_price_feed_quality.py`
- `tests/test_export_fair_price_markouts.py`
- `tests/test_analyze_fair_price_markouts.py`
- `tests/test_pool_price_semantics.py`
