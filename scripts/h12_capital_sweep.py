...
capacity-curve artifact consumed by scripts/h12_capacity_analysis.py — the
...
Usage: python scripts/h12_capital_sweep.py [--output backtester/results/h12/capacity_curve.csv]
"""
...
from backtester.run import WindowSpec, _build_pool_state, _iter_window_slices, resolve_gas_costs
from backtester.simulator import UNISWAP_BASE_POOL, UNISWAP_BSC_POOL, simulate_pool
from backtester.sizing import FixedDeployment
...
def main() -> None:
    ...
    parser.add_argument("--output", default="backtester/results/h12/capacity_curve.csv")
