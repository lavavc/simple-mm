...
Consumes the artifact from scripts/h12_capital_sweep.py. Three outputs per
(pool, config):
...
Usage: python scripts/h12_capacity_analysis.py [--artifact backtester/results/h12/capacity_curve.csv]
"""
...
def main() -> None:
    ...
    parser.add_argument("--artifact", default="backtester/results/h12/capacity_curve.csv")
