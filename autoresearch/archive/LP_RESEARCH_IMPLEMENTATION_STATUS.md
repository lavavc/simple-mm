...
- [scripts/analyze_lp_strategy.py](/Users/johnbeecher/Desktop/automated-infra/scripts/analyze_lp_strategy.py:1)

Example:

```bash
python scripts/analyze_lp_strategy.py --db ./data/cngn.db --venue uni-base
```
